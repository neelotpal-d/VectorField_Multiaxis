...
## Usage
### Files Required:
  - The .obj file of the model to be machined
  - The .obj file for the convex hull of the model
  - .TET file of the removable volume (stock - model). This can generated by a boolean opearation on surface meshes followed by tetrahedralization using [TetGen](https://wias-berlin.de/software/index.jsp?id=TetGen&lang=1)
