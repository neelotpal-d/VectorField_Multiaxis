...
public:
	...
	// variables for rough machining
	bool isIn_convexHull = false;
	Eigen::Vector3d vectorField = Eigen::Vector3d::Zero();
	bool isVectorFiled_Sorce = false; // keep it when smoothing
	...
	bool isPivot = false; // for vector smoothing pivot
