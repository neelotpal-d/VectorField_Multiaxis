...
public:
    ...
    void wcl_to_screen_new(double cx, double cy, double cz, double& sx, double& sy, double& sz);
    ...
    void screen_to_wcl_new(double sx, double sy, double sz, double& cx, double& cy, double& cz);
