...
typedef enum select_type { NODE, EDGE, FACE, FIX, NHANDLE, VECTOR };
...
private:
    ...
    void _selectFaces2(QEvent* event, mouse_event_type event_type);
	void _selectFixed(QEvent *event, mouse_event_type event_type);
	void _selectHandle(QEvent *event, mouse_event_type event_type);
    void _selectHandle2(QEvent* event, mouse_event_type event_type);
